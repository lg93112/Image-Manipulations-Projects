...
class KDTree
{
  ...
  private:
    ...
    void select(int left, int right, int dim, int index);

    void construct(int left, int right, int dim);

    Point<Dim> findNN(int left, int right, int d, const Point<Dim> &query, const Point<Dim> &best) const;
